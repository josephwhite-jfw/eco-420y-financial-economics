...
3) Compute alpha and **plot/label** the stock on the SML.
...
# Code Verification and SML Plot
...
if (alpha > 0) message("Over-performs (above SML).") else message("Under-performs (below SML).")
```
...
2) Actual return 8\% is **below** 10.2\% → **under-performs by 2.2 p.p.**  
